...
title = paste0("<span style='font-family:oranienbaum;font-size:95pt;color:#111111;'>", 
               ...
               "<br>_**Delhi**_ will be the world's most populous city by 2035, followed by 3 other Asian cities.")
...
ggsave(filename='city-population.png', units='px', height=5000, width=4000)
